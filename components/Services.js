  ...
  const services = [
    {
      ...
      text: "Crafting responsive mobile applications using React Native, Expo, and Tailwind CSS.",
    },
    {
      id: 2,
      title: "Web Application Development",
      text: "Building scalable and efficient web applications with Next.js, Tailwind CSS, and TanStack Query.",
    },
    {
      id: 3,
      title: "UI/UX Design",
      text: "Creating user-friendly and aesthetically pleasing interfaces with a focus on modern web and mobile design standards.",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      text: "Designing reusable React and React Native components for consistent and efficient project scaling.",
    },
    {
      id: 6,
      title: "Responsive Design",
      text: "Ensuring that all projects are fully responsive, offering a seamless experience across all devices.",
    },
  ];
  return (
    <section
        ...
        <div className="row justify-content-center">
          <div className="col-xl-6 col-lg-8">
            <div className="section-title text-center mb-60 wow fadeInUp delay-0-2s">
              ...
              <h2>
                My <span className="px-1">Special Service</span> For your Business Development
              </h2>
            </div>
          </div>
        </div>
