          ...
          <div className="row gap-100 align-items-center">
            <div className="col-lg-7">
              <div className="about-content-part rel z-2 rmb-55">
                <div className="section-title mb-35 wow fadeInUp delay-0-2s">
                  ...
                  <h2>
                    Professional <span className="pl-1">  Web and Mobile Apps</span>
                  </h2>
                  <p>
                    Specializing in creating cutting-edge mobile and web
                    applications with a focus on performance, scalability, and
                    beautiful design. Leveraging modern technologies to deliver
                ...
                <div className="about-info-box mt-25 wow fadeInUp delay-0-2s">
                  <div className="info-box-item">
                    ...
                    <div className="content">
                      <span>E-mail Me</span>
                      <br />
                      <a href="mailto:oznurcontact@gmail.com">oznurcontact@gmail.com</a>
                    </div>
                  </div>
            ...
            <div className="col-lg-5">
              <div className="about-image-part wow fadeInUp delay-0-3s">
                <img src="assets/images/about/me.jpeg" alt="About Me" className="rounded-tl-full rounded-br-full  saturate-150"/> 
