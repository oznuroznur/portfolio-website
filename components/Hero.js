        ...
        <div className="row align-items-center">
          <div className="col-lg-4 col-sm-7">
            <div className="hero-content rmb-55 wow fadeInUp delay-0-2s">
              ...
              <h1>
                <b>Öznur Öznur</b> Front-End Developer
              </h1>
              <p className="text-center">
              Crafting seamless digital experiences with precision and creativity.
              <br/>
              🔧  Front-End Developer | 🌐  Building Web and Mobile Apps Wonders
              </p>
              <div className="hero-btns">
                ...
                <Link legacyBehavior href="/contact">
                  <a className="read-more" href="/assets/OznurOznurResume.pdf" target="blank" type="application/pdf">
          ...
          <div className="col-lg-5">
            <div className="author-image-part wow fadeIn delay-0-3s">
              ...
              <img src="assets/images/hero/banner.png" alt="Author"  className="animate-bounceY"/>
