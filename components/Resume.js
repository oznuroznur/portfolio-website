            ...
            <div className="row">
              <div className="col-xl-8 col-lg-9">
                <div className="section-title mb-60 wow fadeInUp delay-0-2s">
                  ...
                  <h2>
                    Real <span className="px-1">Problem Solutions</span> Experience
                  </h2>
                </div>
              </div>
            </div>
              ...
              <div className="col-xl-4 col-md-5 ">
                  <div className="resume-item wow fadeInUp delay-0-3s ">
                    <div className="icon">
                      ...
                      href="https://ideon.com.tr/digital-marketing" target="blank">
                    ...
                    <div className="content ">
                     ...
                     href="https://ideon.com.tr/digital-marketing" target="blank"> <span className="company">Ideon Information Technologies</span></a>
                    </div>
                  </div>
                </div>
                <div className="col-xl-4 col-md-6">
                  <div className="resume-item wow fadeInUp delay-0-4s ">
                    ...
                    <a  
                      className="cursor-pointer "
                      href="https://mebant.com.tr" target="blank">
                      <i className="far fa-arrow-right" />
                      </a>
                    </div>
                    <div className="content">
                      ...
                      <span className="company">MEBANT INSULATION AND TAPE INDUSTRY INC.</span>
                    </div>
                  </div>
                </div>
                <div className="col-xl-4 col-md-5">
                  <div className="resume-item wow fadeInUp delay-0-2s">
                    ...
                    <a  
                      className="cursor-pointer "
                      href="https://www.eosb.org.tr" target="blank">
                      <i className="far fa-arrow-right" />
                      </a>
                    </div>
                    <div className="content">
